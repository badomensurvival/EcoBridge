...
import dev.baraus.ecobridge.database.EcoMysqlHandler;
import dev.baraus.ecobridge.database.MysqlSetup;
import dev.baraus.ecobridge.events.PlayerDisconnect;
import dev.baraus.ecobridge.events.PlayerJoin;
import dev.baraus.ecobridge.events.handlers.EcoDataHandler;
...
public class Ecobridge extends JavaPlugin {
    ...
    public static String pluginName = "Ecobridge";
    ...
    private static final int pluginId = 12248;


    @Override
    public void onEnable() {
        new Metrics(this, Ecobridge.pluginId);
